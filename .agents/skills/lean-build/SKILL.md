...
Exercise path. When repository offers tagged automated cases, run every affected component tag together and skip unrelated tags. Use full suite only when acceptance or cross-cutting risk needs it. Stop when acceptance passes. Report only material omissions and trigger.
