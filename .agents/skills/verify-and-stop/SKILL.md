...
- When repository offers tagged automated cases, map changed behavior to every affected component tag and run those tags together. Skip unrelated tags; reserve full suite for explicit full verification or broad cross-cutting risk.
