...
(async () => {
  ...
  for (const route of ["/", "/admin/", "/campaigns/", "/campaigns/manage.html", "/char/", "/char/tracker.html", "/npc/", "/npc/template/", "/combat-loot/", "/compendium/", "/dm-screen/", "/music/", "/player-screen/", "/public-initiative/", "/wiki/"]) {
