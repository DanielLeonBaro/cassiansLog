...
export function mountSiteHeader({ activePage, actions = "", tracker = false } = {}) {
  ...
  mount.innerHTML = `<div class="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-2 px-4 py-2 sm:flex-nowrap sm:gap-3 sm:px-6 lg:max-w-[100rem] lg:px-8">
