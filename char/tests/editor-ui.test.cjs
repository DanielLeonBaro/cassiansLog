...
assert.match(editor, /id="editor-character-sheet-style"/, "Advanced should include a per-character V1–V4 selector.");
assert.match(editor, /<option value="v4"/, "Advanced should expose opt-in V4.");
