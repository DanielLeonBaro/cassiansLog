...
const pages = [
  { id: "characters", href: "./", icon: "bi-people-fill", label: "Characters" },
...
export function mountSiteHeader({ activePage, actions = "", tracker = false } = {}) {
  ...
  const home = tracker
    ...
    : `<a class="flex h-10 items-center gap-2 font-display text-lg font-semibold hover:text-blood-500" href="./"><i class="bi bi-journal-bookmark-fill text-blood-500"></i>Cassian's Log</a>`;
